...
export default function AppContainer() {
    ...
    const DrawerRoot = () => {
        return (
            <Drawer.Navigator
                screenOptions={{ headerShown: false, animationEnabled: Platform.OS == 'android'? false : true, drawerPosition: isRTL ? 'right' : 'left' }}
    ...
    return (
        <NavigationContainer ref={navigationRef}>
            <Stack.Navigator screenOptions={{ headerShown: false, animationEnabled: Platform.OS == 'android'? false : true}}>
