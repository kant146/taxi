...
export default function SideMenu(props){
    ...
    const { signOut, fetchProfile } = api;
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => {
                       if (auth.info.profile.usertype == 'rider' && (item.navigationName == 'DriverTrips' || item.navigationName == 'MyEarning')) {
                            ...
                            && (auth.info.profile.firstName == " " || auth.info.profile.mobile == " " || auth.info.profile.firstName == "" || auth.info.profile.mobile == "")) {
                            return (
                                <TouchableOpacity
                                    onPress={()=>{convert()}}
                        ...
                        else if (auth.info.profile.usertype == 'rider' && item.navigationName == 'Wallet') {
                            return (
                                <TouchableOpacity
